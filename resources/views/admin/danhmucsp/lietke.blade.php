                    ...
                    <div class="table-responsive">
                         <table class="table table-striped b-t b-light">
                              ...
                              <tbody>
                                   ...
                                   <tr>
                                        <td class="table-plus">{{$item -> iddanhmuc}}</td>
                                        <td>{{$item -> tendanhmuc}}</td>
                                        <td class="table-plus">{{$item -> mota}}</td>
                                        <td>
                                             <div style="width: 30px;">
                                                  @if ($item -> trangthai == 1)
                                                  <a href="{{URL::to('/admin/danhmucsp/hiden/'.$item -> iddanhmuc)}}">
                                                       <input type="checkbox" checked name="hienthi" class="switch-btn" data-size="small" data-color="#0099ff">
                                                  </a>
                                                  @else
                                                  <a href="{{URL::to('/admin/danhmucsp/show/'.$item -> iddanhmuc)}}">
                                        ...
                                        <td>
                                             <table>
                                                  <tr>
                                                       <td>
                                                            <a href="{{URL::to('admin/danhmucsp/sua/'.$item -> iddanhmuc)}}"><i class="dw dw-edit"></i> Edit</a>

                                                       </td>
                                                       <td>
                                                            <form action="{{URL::to('/admin/danhmucsp/xoa/'.$item -> iddanhmuc)}}" method="POST">
                                                                 @csrf
