                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('admin/danhmucsp/hienthi') }}">Liệt kê danh mục</a></li>
                                <li><a href="{{ URL::to('/admin/danhmucsp/them') }}">Thêm danh mục</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('admin/thuonghieu/hienthi') }}">Liệt kê thương hiệu</a></li>
                                <li><a href="{{ URL::to('admin/thuonghieu/them') }}">Thêm thương hiệu</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('admin/sanpham/hienthi') }}">Danh sách sản phẩm</a></li>
                                <li><a href="{{ URL::to('admin/sanpham/them') }}">Thêm sản phẩm</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{ url('admin/donhang') }}">Đơn hàng</a></li>
